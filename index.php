...
<head>
    ...
    body{
        ...
        input[type="submit"]{
            height:32px;
            width:150px;
            box-shadow:0 0 10px 0 #80bdffd0;
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
            ...
            if($error=="success"){
               ?>
                <div class="alert alert-success text-center mt-3 mb-2 alert-dismissible">
                    ...
                    <strong class="text-success">Success!</strong> Balance add <strong class="text-danger">&nbsp;Rs :</strong>&nbsp;<strong class="text-success"><?php echo $amount;?></strong>.
                </div>
               <?php
            }
            if($error=="error"){
                ?>
                 <div class="alert alert-danger text-center mt-3 mb-2 alert-dismissible">
                     <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                     <strong class="text-danger">Warning!</strong> Your account balance is <strong class="text-danger">&nbsp;Rs :</strong><strong class="text-danger">&nbsp;<?php echo $totals;?></strong>.
                 </div>
                <?php
             }
        ?>
        ...
        <div class="card my-3" style="border:none;box-shadow:0 0  5px grey;">
            <div class="card-header" style="background:#4b97f0;">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-6">
                        <h6 class="text-white">Inwards</h6>
                    </div>
                    <div class="col-md-6 col-sm-6 col-6">
                         <a href="outwards.php" style="background:#ef6e14;" class="btn btns btn-sm float-right">Outwards</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form action="" id="reset" onsubmit="return myfun()" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                <label for="">Inwards Title<span class="text-danger">*</span></label>
                    ...
                    <div class="form-group text-center">
                        <input type="submit" name="submit" value="inwards amount" class="btn mt-4 btns btn-sm " style="background:#4b97f0;">
        ...
        <h5 class="text-danger" >Your Recent Inwards</h5>
        <hr>
          <?php 
                ...
                ?>
                        <div class="row mb-2">
                            <?php
                                ...
                                $query=mysqli_query($con,"SELECT * FROM `data` where credit!='' && user_id='$account'");
                                ...
                                $data=mysqli_query($con,"SELECT * FROM `data` where credit!='' && user_id='$account' ORDER BY id DESC LIMIT $this_page_first_result,$result_per_page");
                                
                                while($row=mysqli_fetch_array($data)){
                                ?>
                                     <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                        <div class="card my-2" style=" height:270px;width:100%;box-shadow:0 0 10px 0 grey;border:none;">
                                            <div class="card-header text-white" style="background:#2e87eedc;">
                                            ...
                                            <span style="font-size:11px;"><i class=" text-success fas fa-rupee-sign"></i></span ><span class="text-success">&nbsp;<b>:</b>&nbsp;</span><span style="font-size:12px;"class="text-success text-bold"><b><?php echo $row['credit'];?></b></span>&nbsp;&nbsp;<b style="font-size:11px;color:#be3dcf"><?php echo $row['remark'];?></b><span></span><br>
