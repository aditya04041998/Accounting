                    ...
                    <?php 
                        ...
                        if($row['status']==0){
                            ...
                            <tr style=background:#f6cacee1;>
                                ...
                                <td><a onclick="onClicks()" href="acceptpayrequest.php?account=<?php echo $row['user_id'];?> && id=1 && ref=<?php echo $row['reference']; ?>"  class="btn btns btn-sm btn-success">Accept</a></td>
                                <td><a onclick="onClicks()" href="acceptpayrequest.php?account=<?php echo $row['user_id']; ?> && id=2 && ref=<?php echo $row['reference']; ?>"  class="btn btns btn-sm btn-danger">Reject</a></td>
                            </tr>
                        <?php
                        }
                        if($row['status']==2){
